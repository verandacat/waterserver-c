...
<div class="s_items">
	<div class="s_items_header">
		<div class="upper_left">
			<a target="_blank" href="<?php bloginfo('url'); ?>/links?link_id=<?php echo $post->ID;?>"><img src="<?php echo $attachment_obj; ?>" alt="<?php echo get_post_meta($post->ID,"product_name", true); ?>" width="125" height="125" />
			</a>
		</div>
		<h3 class="list_item_title">
			<a target="_blank" href="<?php bloginfo('url'); ?>/links?link_id=<?php echo $post->ID;?>"><?php echo $t; ?></a>
		</h3>
	</div>

...
<div id="footmark"><a href="https://xn--n8jxc4a9frd5eva0h0d5h5sbbb9158ttlwck6ub.com/">トップページ</a><span>&nbsp;&gt;&nbsp;検索結果</span></div>

<dl class="result pickup">
	<dt>
		<?php if(!is_mobile()){ ?>

		<img src="<?php bloginfo('template_directory'); ?>/img/search/ttl-search-result_pic.png" alt="検索結果" width="186" height="19" class="contents_title" />
	...
	<dd>
		...
		<table>
			...
			<tr>
				<th rowspan="2">
					<a href="<?php bloginfo('url'); ?>/links?link_id=<?php echo $pickup_id;?>&type=pickup" rel="external nofollow">
						<img src="<?php echo get_field('banner',$pickup_id); ?>" alt="<?php echo get_post_meta($pickup_id,"product_name", true); ?>" width="125" height="125" />
					</a>
					<a href="<?php bloginfo('url'); ?>/links?link_id=<?php echo $pickup_id;?>&type=pickup" rel="external nofollow"><?php echo get_post_meta($pickup_id,"product_name", true); ?></a>
				</th>
			...
			<tr>
				...
				<td colspan="3" class="site_link">
					<a href="<?php bloginfo('url'); ?>/links?link_id=<?php echo $pickup_id; ?>&type=pickup" rel="external nofollow"><img src="<?php bloginfo('template_directory'); ?>/img/common/btn-official-site_off.jpg" alt="公式サイトはこちら" width="310" height="60" /></a>
				</td>
			</tr>
		</table>
...
?>
			<tr>
				<th rowspan="2">
					...
					<a href="<?php bloginfo('url'); ?>/links?link_id=<?php echo $post['id'];?>" rel="external nofollow"><?php echo $post["product_name"]; ?></a>
				</th>
			...
			<tr>
				...
				<td colspan="3" class="site_link">
					<a href="<?php bloginfo('url'); ?>/links?link_id=<?php echo $post['id'];?>" rel="external nofollow"><img src="<?php bloginfo('template_directory'); ?>/img/common/btn-official-site_off.jpg" alt="公式サイトはこちら" width="310" height="60" /></a>
				</td>
			</tr>
<?php
}
	...
	<dd>
		...
		<table class="sort_box_a" cellspacing="0" cellpadding="0">
			<tr id="" class="item_name_sp">
				<td nowrap style="white-space: nowrap;"><span>お水の価格</span><br/><a href="#" class="water_cost">▲</a><a href="#" class="water_cost" data-d="d">▼</a></td>
				<td nowrap style="white-space: nowrap;"><span>サーバー料金/月</span><br/><a href="#" class="server_cost">▲</a><a href="#" class="server_cost" data-d="d">▼</a></td>
			</tr><tr class="item_name_sp">
				<td><span>配送料</span><br/><a href="#" class="shipping_cost">▲</a><a href="#" class="shipping_cost" data-d="d">▼</a></td>
				<td nowap style="white-space: nowrap;"><span>電気代/月</span><br/><a href="#" class="electricity_cost">▲</a><a href="#" class="electricity_cost" data-d="d">▼</a></td>
			</tr>
		</table>
	</dd>
</dl>

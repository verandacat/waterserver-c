...
<a href="<?php bloginfo('url'); ?>/ranking" id="banner_ranking_sub"><img src="<?php bloginfo('template_directory'); ?>/img/common/bnr-ranking-side_off.jpg" alt="2014年版人気ランキング　今年No.1のおすすめウォーターサーバーは？　ランキング詳細はこちら" width="230" height="234" /></a>
<?php
...
<a href="<?php bloginfo('url'); ?>/premium-water/" id="banner_ranking_sub"><img src="<?php bloginfo('template_directory'); ?>/img/waterserver-b_pc.png" alt="2014年版人気ランキング　今年No.1のおすすめウォーターサーバーは？　ランキング詳細はこちら" width="230" height="auto" /></a>
<?php

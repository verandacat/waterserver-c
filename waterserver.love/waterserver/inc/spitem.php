   ...
   <td rowspan="5">
     ...
     <a href="<?php the_permalink($post['id']); ?>" rel="external nofollow"><?php echo get_post($post['id'])->post_title; ?>
       </h3>
   </td>
   <td colspan="3"><?php echo $post['water_cost']; ?></td>
   <td colspan="3"><?php echo $post['server_cost']; ?></td>
   </tr>
   <tr id="item_name">
     <td colspan="3">配送料</td>
   ...
   <tr>
     ...
     <td colspan="3"><?php echo $post['electricity_cost']; ?></td>
   </tr>
   <tr id="item_name">
   ...
   <tr class="spac">
     <td colspan="6" class="left site_link">
       ...
       <p><?php //echo get_field("recommend_description", $post['id']); 
          ?></p>
        <a href="<?php the_permalink($post['id']); ?>" rel="external nofollow"><img class="kousiki" src="<?php bloginfo('template_directory'); ?>/img/btn-official-site.jpg" alt="公式サイトはこちら" /></a>
     </td>
   </tr>

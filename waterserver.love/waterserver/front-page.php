...
<div id="main_contents" class="topcontent">
  ...
  <div style="text-align: center; margin-top: 30px">
    <a href="https://waterserver.love/link/frecious.html?type=4" rel="external nofollow" target="_blank">
      <img src="<?php bloginfo('template_directory'); ?>/img/frecious_slatcafe_f1box_468_60.jpg" alt="">
    </a>
  </div>
  <?php else : ?>

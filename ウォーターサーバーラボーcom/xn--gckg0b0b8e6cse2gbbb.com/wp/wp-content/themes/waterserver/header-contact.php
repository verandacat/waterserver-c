...
<?php }else{ ?>
<div id="header">
	<img src="<?php bloginfo('template_directory'); ?>/images/soudan-header.jpg" style="width:100%;max-width:680px;" /> 
<?php } ?>
<?php else: ?>
<style>
#header {
    height: 200px;
    background-image: url(https://xn--gckgmmx3dygqimdb6gbbb4235ic1qdgxegw1a.com/wp-content/themes/waterserver/images/soudan-header-pc.jpg);
    overflow: hidden;

		...
		<table>
			...
			<tr>
				<th rowspan="2">
					...
					<a href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $pickup_id;?>&type=pickup" rel="external nofollow"><?php echo get_post_meta($pickup_id,"product_name", true); ?></a>
				</th>
			...
			<tr>
				...
				<td colspan="3" class="site_link">
					<a href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $pickup_id; ?>&type=pickup" rel="external nofollow"><img src="<?php bloginfo('template_directory'); ?>/img/common/btn-official-site_off.jpg" alt="公式サイトはこちら" width="310" height="60" /></a>
				</td>
			</tr>
		</table>

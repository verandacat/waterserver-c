...
<dl id="easy_search">
	...
	<dd>
				...
				<td>
					<ul class="list_wide">
						...
						<li>
							...
							<label for="filtering01_04">
				<?php if(!is_mobile()){ ?>赤ちゃんの<?php } ?>ミルク作りに最適</label>
						</li>
			...
			<tr>
				...
				<td>
					<ul class="list_widesp">
						...
						<?php }else{ ?>
						<li>
							<select name="water_type" id="">
								<option value="">お水の種類</option>
								<option value="natural">天然水</option>
								<option value="ro">RO水</option>
							</select>
						</li>
						<li>
							<select name="rental_fee" id="">
								<option value="">サーバレンタル代</option>
								<option value="free">無料</option>
								<option value="charge">有料</option>
							</select>
						</li>
						<?php } ?>
					</ul>
			...
			<tr>
				...
				<td>
					<ul class="list_widesp">
						...
						<li>
							<input type="radio" name="bottle" id="filtering03_04" value="connection" <?php if (isset($_POST['bottle']) && $_POST['bottle'] == 'connection') { echo 'checked="checked"'; } ?>/>
							<label for="filtering03_03">コネクト（水道直結）方式</label>
						</li>
						<?php }else{ ?>
						<li>
							<select name="" id="bottle">
								<option value="">ボトルの種類</option>
								<option value="">ワンウェイ（使い捨て）方式</option>
								<option value="">リターナブル（返却）方式</option>
								<option value="">コネクト（水道直結）方式</option>
							</select>
						</li>
						<li>
							<input type="radio" name="shipping_fee" id="filtering05_01" value="free" checked="checked" />
							<label for="filtering05_01">配送料無料</label>
						</li>
						<?php } ?>
					</ul>
				</td>
		...
		<dl id="search_more">
			<dt>
				<?php if(!is_mobile()){ ?>
					<img src="<?php bloginfo('template_directory');  echo $img_name; ?>" alt="さらにこだわって選びたい方はこちら" width="686" height="40" />
				<?php }else{ ?>
					<div id="morebutton">
						さらにこだわって選びたい方はこちら
					</div>
...
-->
		...
		<a href="javascript:void(0)" id="btn_search_start"><img src="<?php bloginfo('template_directory'); ?>/img/top/btn-search-start_off.jpg" alt="あなたにおすすめのウォーターサーバーを検索開始" width="610" height="60" /></a>
		<?php }else{ ?>
		<a href="javascript:void(0)" id="btn_search_start">
			ウォーターサーバー<span>を</span>検索
		</a>
		<?php } ?>
	</dd>
</dl>
